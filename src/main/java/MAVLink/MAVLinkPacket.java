...
public class MAVLinkPacket implements Serializable {
 ...
 // MAVLinkPacket 클래스에 toString 메서드 추가
    @Override
    public String toString() {
        StringBuilder builder = new StringBuilder();
        builder.append(String.format("MAVLinkPacket [isMavlink2=%s, seq=%d, sysid=%d, compid=%d, msgid=%d, payload=%s, crc=%s]",
                isMavlink2, seq, sysid, compid, msgid, payload, crc));
    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
                ...
                return  new msg_fence_status(this);
                        case msg_monitoring.MAVLINK_MSG_ID_MONITORING:
                return  new msg_monitoring(this);
                        case msg_scenario_cmd.MAVLINK_MSG_ID_SCENARIO_CMD:
                return  new msg_scenario_cmd(this);
